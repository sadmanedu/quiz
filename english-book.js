...
window.EnglishBook = (() => {
  ...
  const topics = [
    ...
    },
    {
      id: "plants-rhymes",
      title: "Plants & Rhymes",
      description: "Seeds, plants, birds and rhymes",
      icon: "🌱",
      questions: [
        q("Which part holds a plant in the ground?", "Roots", ["Wings", "Wheels", "Pages"], "Roots মাটিতে গাছকে ধরে রাখে।", "🌱"),
        q("Which part of a plant is usually green?", "Leaf", ["Wheel", "Pencil", "Window"], "পাতা বা leaf সাধারণত সবুজ হয়।", "🍃"),
        q("What do roots take from the soil?", "Water", ["Books", "Kites", "Chairs"], "Roots মাটি থেকে পানি নেয়।", "💧"),
        q("What do flowers help a plant make?", "Seeds", ["Road signs", "Robots", "Buses"], "ফুল থেকে বীজ তৈরি হতে পারে।", "🌼"),
        q("What should you do when a plant looks dry?", "Give it water", ["Throw it away", "Cover it with books", "Step on it"], "গাছ শুকনো দেখালে তাকে পানি দিতে হয়।", "💧"),
        q("Which question can ask about a plant's growth?", "How does a plant grow?", ["What is your name?", "Where do you live?", "How old are you?"], "গাছের বেড়ে ওঠা জানতে ‘How does a plant grow?’ বলা হয়।", "?"),
    ...
    },
    {
      ...
      description: "Day names and their correct order",
      icon: "📅",
      questions: [
        q("How many days are there in a week?", "Seven", ["Five", "Six", "Twelve"], "এক সপ্তাহে seven বা সাত দিন থাকে।", "7"),
        ...
        q("What day comes after Tuesday?", "Wednesday", ["Monday", "Thursday", "Friday"], "Tuesday-এর পরে Wednesday আসে।", "📅"),
        q("What day comes after Wednesday?", "Thursday", ["Tuesday", "Friday", "Sunday"], "Wednesday-এর পরে Thursday আসে।", "📅"),
        q("What day comes after Thursday?", "Friday", ["Wednesday", "Saturday", "Monday"], "Thursday-এর পরে Friday আসে।", "📅"),
        q("What day comes after Friday?", "Saturday", ["Sunday", "Thursday", "Tuesday"], "Friday-এর পরে Saturday আসে।", "📅"),
        q("What day comes after Saturday?", "Sunday", ["Monday", "Friday", "Wednesday"], "Saturday-এর পরে Sunday আসে।", "📅"),
        q("What day comes before Sunday?", "Saturday", ["Friday", "Monday", "Tuesday"], "Sunday-এর আগে Saturday আসে।", "📅"),
        q("What day comes before Friday?", "Thursday", ["Wednesday", "Saturday", "Monday"], "Friday-এর আগে Thursday আসে।", "📅"),
        q("Which day is between Monday and Wednesday?", "Tuesday", ["Sunday", "Thursday", "Friday"], "Monday ও Wednesday-এর মাঝে Tuesday থাকে।", "📅"),
        q("Which list is in the correct order?", "Monday, Tuesday, Wednesday", ["Monday, Wednesday, Tuesday", "Friday, Thursday, Saturday", "Sunday, Saturday, Monday"], "Monday-এর পরে Tuesday, তারপর Wednesday আসে।", "✓"),
        q("Which question asks about today's day?", "What day is today?", ["What is your name?", "Where do you live?", "How old are you?"], "আজ কী বার জানতে ‘What day is today?’ বলা হয়।", "?"),
        q("What does ‘yesterday’ mean?", "The day before today", ["The day after today", "Today only", "Next week"], "Yesterday মানে আজকের আগের দিন।", "←"),
        q("What does ‘tomorrow’ mean?", "The day after today", ["The day before today", "Last year", "Yesterday"], "Tomorrow মানে আজকের পরের দিন।", "→"),
        q("What day comes two days after Monday?", "Wednesday", ["Tuesday", "Thursday", "Friday"], "Monday-এর দুই দিন পরে Wednesday আসে।", "2"),
        q("Which one is a day of the week?", "Thursday", ["January", "Blue", "Triangle"], "Thursday সপ্তাহের একটি দিনের নাম।", "📅"),
        q("Why do we learn day names?", "To talk about time and plans", ["To change colours", "To draw only circles", "To feed books"], "দিনের নাম জানলে সময় ও পরিকল্পনা সম্পর্কে কথা বলা যায়।", "★")
      ]
    },
    {
      id: "months-year",
      title: "12 Months of the Year",
      description: "Month names and their correct order",
      icon: "🗓",
      questions: [
        q("How many months are there in a year?", "Twelve", ["Seven", "Ten", "Thirty"], "এক বছরে twelve বা ১২টি মাস থাকে।", "12"),
        q("What is the first month of the year?", "January", ["December", "March", "June"], "বছরের প্রথম মাস January।", "Jan"),
        q("What month comes after January?", "February", ["March", "December", "April"], "January-এর পরে February আসে।", "Feb"),
        q("What month comes after February?", "March", ["April", "January", "May"], "February-এর পরে March আসে।", "Mar"),
        q("What month comes after March?", "April", ["May", "February", "June"], "March-এর পরে April আসে।", "Apr"),
        q("What month comes after April?", "May", ["June", "March", "July"], "April-এর পরে May আসে।", "May"),
        q("What month comes after May?", "June", ["July", "April", "August"], "May-এর পরে June আসে।", "Jun"),
        q("What month comes after June?", "July", ["August", "May", "September"], "June-এর পরে July আসে।", "Jul"),
        q("What month comes after July?", "August", ["September", "June", "October"], "July-এর পরে August আসে।", "Aug"),
        q("What month comes after August?", "September", ["October", "July", "November"], "August-এর পরে September আসে।", "Sep"),
        q("What month comes after September?", "October", ["November", "August", "December"], "September-এর পরে October আসে।", "Oct"),
        q("What month comes after October?", "November", ["December", "September", "January"], "October-এর পরে November আসে।", "Nov"),
        q("What month comes after November?", "December", ["January", "October", "February"], "November-এর পরে December আসে।", "Dec"),
        q("What month comes before May?", "April", ["March", "June", "July"], "May-এর আগে April আসে।", "Apr"),
        q("What month comes before December?", "November", ["October", "January", "September"], "December-এর আগে November আসে।", "Nov"),
        q("Which one is a month of the year?", "August", ["Monday", "Circle", "Green"], "August বছরের একটি মাসের নাম।", "🗓"),
        q("Which list is in the correct order?", "January, February, March", ["January, March, February", "April, June, May", "December, November, January"], "January-এর পরে February, তারপর March আসে।", "✓"),
        q("Why do we learn month names?", "To talk about dates and birthdays", ["To change road signs", "To make animal sounds", "To draw only stars"], "মাসের নাম জানলে তারিখ, জন্মদিন ও বছরের সময় সম্পর্কে কথা বলা যায়।", "🎂")
      ]
    },
    {
      id: "sounds-rhymes",
